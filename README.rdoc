...
You can also get an hash having all the cached URLs with their share counts:
	...
	ruby-1.9.2-p0 :009 > ShareCounts.cached
	 => {"http://vitobotta.com/awesomeprint-similar-production/"=>{:stumbleupon=>0, :linkedin=>2, :googlebuzz=>0, :facebook=>1, :twitter=>2, :reddit=>5}}
